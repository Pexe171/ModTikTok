...
public final class ForgeEntrypoint {
    public ForgeEntrypoint() {
        ...
        modBus.addListener((RegisterGuiOverlaysEvent event) ->
                event.registerAboveAll("hud", (gui, graphics, partialTick, width, height) ->
                        ClientEvents.renderHud(graphics)));
        ...
        TikTokChaosMod.LOGGER.info("TikTok Chaos carregado para Forge 1.20.1");
    }
}
