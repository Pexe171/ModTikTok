...
public final class TikTokChaosHud {
    ...
    public static void render(MatrixStack matrixStack) {
        ...
        AbstractGui.fill(matrixStack, x, y, x + 226, y + 54, 0xB5120D1D);
        AbstractGui.fill(matrixStack, x, y, x + 3, y + 54, statusColor(runtime.status()));
        minecraft.font.drawShadow(matrixStack, "TikTok Chaos - " + runtime.status().label(), x + 9, y + 7,
                0xFFF4E9FF);
